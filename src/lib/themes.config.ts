...
export const THEME_CONFIGS: ThemeConfig[] = [
  ...
  },
  {
    ...
    tokens: {
      ...
      success: "140 70% 45%",
      successForeground: "0 0% 3%",
      warning: "48 80% 55%",
      warningForeground: "0 0% 3%",
      destructive: "0 80% 50%",
      ...
      sidebarPrimaryForeground: "0 0% 3%",
      sidebarAccent: "0 0% 7%",
    ...
    gradients: {
      primary: "linear-gradient(135deg, hsl(48 80% 50%), hsl(48 100% 60%))",
      accent: "linear-gradient(135deg, hsl(48 80% 50%), hsl(45 90% 40%))",
      warm: "linear-gradient(135deg, hsl(48 80% 50%), hsl(45 90% 55%))",
      mesh: "transparent",
    },
    lighting: {
      glassBg: "0 0% 7% / 0.75",
      glassBorder: "48 80% 50% / 0.65",
      glassShadow: "0 0% 0% / 0.85",
      shadowGlow: "0 0 35px hsl(48 80% 50% / 0.25)",
      shadowElevated: "0 20px 50px -15px hsl(0 0% 0% / 0.7)",
      shadowGlass: "0 10px 30px hsl(0 0% 0% / 0.85), inset 0 1px 0 hsl(48 80% 90% / 0.1)",
      mood: "warm",
    },
  },
];
